...
describe('computeSignificance', () => {
  ...
  it('weights relevance above severity', () => {
    // Centrality to the question matters more than how bad the slip was.
    const highRelevance = computeSignificance({ ...base, relevance: 5, severity: 1 })
    const highSeverity = computeSignificance({ ...base, relevance: 1, severity: 5 })
