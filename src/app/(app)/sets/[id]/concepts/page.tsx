 ...
 * its owner, a `KLT_EDITORS` operator, or someone holding the link to a
 * link-shared set. `canEdit` is what separates the editor from the read-only
 * view; it comes from the same rule the write gate applies, and every write
 * re-checks `requireSetKltAccess` server-side regardless of what this page
 * decided to render.
 *
