/**
 * A seeded PRNG (mulberry32) so a game run is reproducible: the same seed
 * gives the same room order, the same tile shuffle, the same crossword.
 * Tests rely on it; a learner never sees the seed.
 */
