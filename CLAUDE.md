...
- This memory feeds later stages: weak cards should be surfaceable and testable. Design the schema so confidence history (not just latest value) can be queried for the training-plan AI in Stage 3.
